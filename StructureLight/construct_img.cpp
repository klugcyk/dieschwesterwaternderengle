...
/*
    ...
    @srcImg:多激光线图像
    @resImg:提取激光中心线结果的图像32位浮点型
    @zenturm:激光中心点存储地址
*/
int construct_img::laserZenturmLineMulti(cv::Mat srcImg,cv::Mat &resImg,float *zenturm)
{
    int lineCnt=0;
...
/*
    ...
    @points:提取到点的坐标
*/
void construct_img::construct_img_multi_test(cv::Mat src_img,cv::Mat &res_img,std::vector<std::vector<cv::Point2f>> &pointsSet)
{
    res_img=src_img;
